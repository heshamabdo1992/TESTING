...
public class Add_order_withSQL2 {
   ...
   /////////////////////>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>     
       ...
       // Thread.sleep(10000);
        ...
        ///////////////////to insert software and serial 
        	if(end_process!=true) {
       		select_software(Version,index_1,Serial);
        	}
     	//next btn 
        ...
        if(end_process!=true) {
        select_dongle_location( country.get(0));
        }
       // Thread.sleep(10000);
////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		////////////////////////////////////////////////////////////
        if(end_process!=true) {
		select_dongle(D_Type.get(0),index_1.get(0),Dongle_SerialName.get(0));
        }
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/////////////////////////////select dongle serial and uid
		/////////////////////////////////////////////////////////////////////////////////////
        if(end_process!=true) {
		set_dongle_param (Dongle_SerialName.get(0),D_Name.get(0),D_Serial.get(0),D_Type.get(0),SPF.get(0),index_1.get(0));
        }
        }catch(Exception e)
{
        	System.out.println("Exception "+e);
            addtotextfile("-----------failed------------", true);
            addtotextfile("Exception "+e, true);   	
}
        }  
	...
	public void select_dongle_location(String country) throws IOException, InterruptedException {
		System.out.println(country+" is country");
 		addtotextfile(country+" is country", true);
try {
		//To select the dongle location
		Select Location = new Select
				(driver.findElement(By.xpath(
						"//*[@id=\"ContentPlaceHolder1_wzd_TabContainer1_TabPanel0_ddl_Location\"]")));
        
		if(country.contains("gypt"))
        {        Thread.sleep(4000);
...
catch (Exception e)
{
	...
	public void select_dongle(String D_Type,String index_1,String Dongle_SerialName) throws IOException, InterruptedException
	{
		...
		System.out.println(D_Type+" is dongle type");
		addtotextfile(D_Type+" is dongle type", true);

		//System.out.println(D_Type.get(0)+" is dongle type");

		if(D_Type.contains("3"))
		{
//			Select dongleCat2 = new Select(driver.findElement(
//					By.xpath(
//				"//*[@id='ContentPlaceHolder1_wzd_TabContainer1_TabPanel0_ddl_DongleCategories']")));

			if(D_Type.contains("net") || D_Type.contains("Net") 
					|| D_Type.contains("NET") || D_Type.contains("nET")) {
		        Thread.sleep(5000);
		        ...
		        System.out.println(D_Type+" Selected category");
...
//   				dongleCat2.selectByValue("6");
		...
		else if(D_Type.contains("1"))
		{
	        ...
	        Thread.sleep(10000);
     		...
     		System.out.println(index_1+" is skipped");
     		//System.out.println(D_Type.get(0)+" is not existed");
     		System.out.println(D_Type+" dongle type is not existed");
     		System.out.println(Dongle_SerialName+" dongle serial is not existed");
     		addtotextfile(index_1+" is  skipped", true);
	       // addtotextfile(customername.get(0)+" customer name is not existed", true);
	        addtotextfile(D_Type+" dongle type is not existed", true);
	        addtotextfile(Dongle_SerialName+" dongle serial is not existed", true);
	...
	public void set_dongle_param(String Dongle_SerialName,String D_Name,String D_Serial,String D_Type,String SPF,String index_1) throws InterruptedException, IOException {
		...
		String[] selectdongle = SelectElementContainsItemText(dongleserial,Dongle_SerialName).split("^");
		
		if(selectdongle[0].contains("true"))
        {
		dongleserial.selectByVisibleText(Dongle_SerialName.trim());
       ...
       // int result1 = Integer.parseInt(D_Name.get(0));
		Param_name.sendKeys(D_Name);
		Param_code.clear();
		//int result2 = Integer.parseInt(D_Serial.get(0));
		Param_code.sendKeys(D_Serial);
		add_btn.click();
        Thread.sleep(4000);
        ...
        addtotextfile(Dongle_SerialName+" dongle uid is added", true);
        addtotextfile(SPF+" SPF is added", true);
        addtotextfile(index_1+" index is added", true);
        addtotextfile("-----------sucess------------", true);
        addtotextfile2(index_1, true);
		Thread.sleep(1000);
        }
        else
        {
        	System.out.println(D_Type+" dongle type is not existed");
     		System.out.println(Dongle_SerialName+" dongle serial is not existed");
     		System.out.println(SPF+" SPF is  not added");
     	//	System.out.println(Dongle_SerialName.get(0)+" dongle serial is not existed");
     		
            addtotextfile(Dongle_SerialName+" dongle uid is not add", true);
            addtotextfile(SPF+" SPF is  not added", true);
            addtotextfile(index_1+" index is not added", true);
    ...
    public void select_software(List<String>  Version,List<String> index_1,List<String> Serial ) throws IOException, InterruptedException {
        ///////////////////to insert software and serial 
        for(int x =0;x<Version.size();x++) {
     ...
     //Ultima
         	...
         	if(Version.get(x).contains("7.1.0")) {
         		...
         		Software_Version.selectByVisibleText("3.4.13.0");
         		}
         	...
         	else if(Version.get(x).contains("4.6.3")) {
         		Software_Version.selectByVisibleText("4.6.3");
     		}
         	...
         	else if(Version.get(x).contains("5.0.0.5")) {
         		Software_Version.selectByVisibleText("5.0.0.5");
     		} 
